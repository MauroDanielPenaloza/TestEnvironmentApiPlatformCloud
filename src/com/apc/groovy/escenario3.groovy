...
ApiRuntimeContext context = ApiContextMockFactory.apiRuntimeContextE3()
...
Runnable runneable =  new Runnable (){
    ...
    static class ApiReq {
        @com.fasterxml.jackson.dataformat.xml.annotation.JacksonXmlProperty(localName = "ID")
        String id
    }
    static class BodySoap {
        @com.fasterxml.jackson.dataformat.xml.annotation.JacksonXmlProperty(localName = "Request")
        ApiReq req
    }

    static class MsgSoap{
        @com.fasterxml.jackson.dataformat.xml.annotation.JacksonXmlProperty(localName = "Header")
        String header
        @com.fasterxml.jackson.dataformat.xml.annotation.JacksonXmlProperty(localName = "Body")
        BodySoap body
    }
    ...
    String makeRequestBody(){
        ...
        MsgSoap msg = map.readValue(context.getApiRequest().getBody().asString(), MsgSoap.class)
        if(msg != null && msg.getBody()!= null && msg.getBody().getReq() != null){
            payload.nombreService = msg.getBody().getReq().getId()
        }
